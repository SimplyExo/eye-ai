...
pub struct MetricDepthModel {
	relative_depth_model: DepthModel,
}
impl MetricDepthModel {
	...
	pub fn new(
		...
		let relative_depth_model = DepthModel::new(relative_depth_model_create_info)?;
