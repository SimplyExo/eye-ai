...
Transcript outputs (``../../../01_Trainingsdaten/nicht_aktuell/ASR-Generierung-und-QC/generated/<split>/``):
...
QC files (``train/``, ``validation/``, ``blind/``):

- `qc.csv` - sample-level provenance and status
