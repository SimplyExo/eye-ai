...
class Text2NumGermanNumberNormalizerTest {
	...
	fun `pinned normalizer matches Python decimal article and connector vectors`() {
		val cases = listOf(
			...
			Golden(
				"für die bps stell bitte fünf komma acht ein",
				"für die bps stell bitte <NUM> ein",
				listOf(5.8),
				NumberNormalizationStatus.SUCCESS
			),
			Golden(
				"stell b p s fünf ein",
				"stell b p s <NUM> ein",
				listOf(5.0),
				NumberNormalizationStatus.SUCCESS
			),
			Golden(
				"wechsel die stimme und nimm die maskuline",
				"wechsel die stimme und nimm die maskuline",
				emptyList(),
				NumberNormalizationStatus.NO_NUMBER
			),
			Golden(
				"eins komma", "<NUM> <NUM>", listOf(1.0), NumberNormalizationStatus.PARTIAL_FAILURE
			),
			Golden(
				"von sechshundert auf siebenhundert",
				"von <NUM> auf <NUM>",
				listOf(600.0, 700.0),
