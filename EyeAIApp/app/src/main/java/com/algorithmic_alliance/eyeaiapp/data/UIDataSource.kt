    ...
    val APP_SETTINGS = mapOf<String, Any>(
        ...
        "Depth Estimation" to listOf(
            ...
            mapOf(
				...
				"description" to "Disable for unrestricted MiDaS operation.",
                "settingsType" to "checkbox",
            ...
            mapOf(
				...
				"description" to "Maximum MiDaS inference rate; CameraX continues to capture independently. Disable the limiter for unrestricted operation.",
        ...
        "Object Detection" to listOf(
            ...
            mapOf(
                "title" to "Enable Framerate Limiter",
				"description" to "Disable for unrestricted YOLO operation.",
                "settingsType" to "checkbox",
