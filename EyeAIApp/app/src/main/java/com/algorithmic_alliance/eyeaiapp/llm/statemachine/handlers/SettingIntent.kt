...
internal fun SettingIntent.missingOperationQuestion(): String = when (this) {
	SettingIntent.TTS_SPEED -> "Verstanden, Sie möchten die Sprechgeschwindigkeit anpassen. " + "Möchten Sie die Sprechgeschwindigkeit erhöhen, verringern oder einen konkreten Wert einstellen?"

	SettingIntent.VOICE -> "Verstanden, Sie möchten die Assistentenstimme anpassen. " + "Möchten Sie die männliche, weibliche oder die andere verfügbare Stimme verwenden?"

	SettingIntent.FREQUENCY -> "Verstanden, Sie möchten die Frequenz der Distanzhinweistöne anpassen. " + "Möchten Sie die Frequenz erhöhen, verringern oder einen konkreten Wert einstellen?"

	SettingIntent.BPS -> "Verstanden, Sie möchten die Schläge pro Sekunde der Distanzhinweistöne anpassen. " + "Möchten Sie die BPS erhöhen, verringern oder einen konkreten Wert einstellen?"
